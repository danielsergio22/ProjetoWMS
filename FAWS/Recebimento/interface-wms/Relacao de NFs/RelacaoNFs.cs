...
namespace interface_wms
{
    public partial class FrmRelacaoNF : Form
    {
        ...
        public FrmRelacaoNF()
        {
            ...
            AbasFormatacoes.PassarCampos(btnBuscarRelNFs, btnVertodosRel, btnCancelarNF, btnMenuRelNF);
            ...
            AbasFormatacoes.PassarCampos(tsmiRecebimentoRelNF, tsmiSistemaRelNFs, tsmiUsuarioRelNFs, 
                                        ...
                                        tsmiPreferenciasRelNFs, tsmiVerMatriculaRelNFs);
            ...
            AbasFormatacoes.PassarCamposCabecalho(lbNomeSistemaRelNF, lbDataHoraRelNF, lbUsuarioRelNF, lbNomeMatriculaRelNF, lbNomeCompaniaRelNF);
        ...
        private void btnMenuNF_Click(object sender, EventArgs e)
        {
            this.Close();
        }
